...
import 'package:twenty_four_hours/Gym/main.dart';
  ...
  Widget build(BuildContext context) {
    return AuthProvider(
        ...
        child: new MaterialApp(
          ...
          home: new RootPage(), // user!=null ? HomePage():LoginActivityMain(),
          routes: <String, WidgetBuilder>{
            "/Home": (BuildContext context) => new HomePage(),
            "/Login": (BuildContext context) => new LoginActivityMain(),
            "/Register": (BuildContext context) => new RegisterMain(),
            "/Gym": (BuildContext context) => new GymMain(),
          },
        ));
  }
}
