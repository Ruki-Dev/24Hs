...
class TextWithExponent extends StatelessWidget {
  ...
  TextWithExponent(this.text, this.exponentText,
      {this.textSize = 25.0, this.exponentTextSize = 18.0});
  ...
  Widget build(BuildContext context) {
    return new Row(
      children: <Widget>[
        ...
        new Container(
          child: new Text(exponentText,
              style: new TextStyle(fontSize: exponentTextSize)),
