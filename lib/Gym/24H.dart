...
/*
class TwentyFourH extends StatefulWidget
{
  final String title;
  TwentyFourH({Key key,this.title}): super(key: key);
  TwentyFourHState createState()=>new TwentyFourHState();
}
*/

class TwentyFourHWidget extends StatelessWidget {
  final Profile profile;

  TwentyFourHWidget({this.profile});
              ...
              const DecoratedBox(
                decoration: const BoxDecoration(
                  gradient: const LinearGradient(
                    ...
                    colors: const <Color>[Colors.green, Colors.black12],
                  ),
                ),
              ),
              _Header(
